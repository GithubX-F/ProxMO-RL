...
gr.Interface(
    ...
    title="WebShop",
    article="<p style='padding-top:15px;text-align:center;'>To learn more about this project, check out the <a href='' target='_blank'>project page</a>!</p>",
