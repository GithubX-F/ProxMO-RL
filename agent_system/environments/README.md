...
Note: If you encounter issues with gdown, you may need visit ` get your Google Drive cookie, and paste it into `.cache/gdown/cookies.txt`.
...
```bash
cd repo_root/
pip3 install torch==2.6.0 --index-url 
