...
class EnvironmentManagerBase:
    ...
    def reset(self, kwargs) -> Dict[str, Any]:
        ...
        - next_observations (Dict):
          ...
          - 'anchor' (None or Any): Anchor observation without any histories or additional info. (for ProxMO only).
        """
    ...
    def step(self, text_actions: List[str]):
        ...
        next_observations = {
            ...
            'image': next_obs,
            'anchor': None # For ProxMO only. anchor observation without any histories, hint, etc. Implement this if needed
        }
